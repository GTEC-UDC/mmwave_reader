    ...
    def sdk3xTLVHeader(self, dataIn):
        ...
        for i in range(numTLVs):
            ...
            if (tlvType == 1):
                ...
                newDataIn = newDataIn[tlvLength:]
                print('Size of newDataIn after parse tlv4: %d'%(len(newDataIn)))
            elif (tlvType == 5):
                self.parseSDK3xDopplerHeatmap(newDataIn[:tlvLength])
                newDataIn = newDataIn[tlvLength:]
                print('Size of newDataIn after parse tlv5: %d'%(len(newDataIn)))
            elif (tlvType == 2):
                newDataIn = newDataIn[tlvLength:]
                print('Size of newDataIn after parse tlv2: %d'%(len(newDataIn)))
            elif (tlvType == 3):
                newDataIn = newDataIn[tlvLength:]
                print('Size of newDataIn after parse tlv3: %d'%(len(newDataIn)))
            elif (tlvType == 6):
                newDataIn = newDataIn[tlvLength:]
                print('Size of newDataIn after parse tlv6: %d'%(len(newDataIn)))
            else:
                newDataIn = newDataIn[tlvLength:]
                print('Size of newDataIn after parse other tlv: %d'%(len(newDataIn)))
        return newDataIn
