...
#It can parse the SDK3.x Compliant People Counting demo "tracker_dpc"
    ...
    def readAndParseUart(self):
        ...
        if (self.fail):
            return self.pcPolar, self.pcBufPing, self.targetBufPing, self.indexes, self.numDetectedObj, self.numDetectedTarget, self.frameNum, self.fail, self.classifierOutput
        if (self.saveBinary):
